...
@Autonomous(name = "TopBlue", group = "Pushbot")
//@Disabled
public class TopBlue extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        //top left blue
        //encoderDrive(DRIVE_SPEED, 10, 10, 1.2); //turn left
        //encoderDrive(DRIVE_SPEED, 0, 0, 1);
        //strafe(DRIVE_SPEED, -10, -10, 10, 10, 1);
        encoderDrive(DRIVE_SPEED, -11, -8, 1);

        encoderDrive(DRIVE_SPEED, -10, 10, 1); // move front
        encoderDrive(DRIVE_SPEED, 8, 11, 1);
        encoderDrive(DRIVE_SPEED, -10, 10, 1.2); // move front


        //encoderDrive(DRIVE_SPEED, -10, -10, 1); //turn right
        //encoderDrive(DRIVE_SPEED, -10, 10, 0.8); // move front
