...
public class HardwareMechanumAthenabot
{
   ...
   public static final double SERVO_BOX_MIN = 0.0;
   public static final double SERVO_BOX_MAX = 1.0;
   public static final double SERVO_GATE_MIN = 0.0;
   public static final double SERVO_GATE_MAX = 1.0;
   public static final double SERVO_HAND1_MAX = 1.0;
   public static final double SERVO_HAND1_MIN = 0.0;
   public static final double SERVO_HAND2_MAX = 0.0;
   public static final double SERVO_HAND2_MIN = 0.0;
   ...
   public static final double shaft_power = 1.00;
   ...
   public void init(HardwareMap ahwMap) {
     ...
     /*try {
       ...
       try {
           //v_motor_left_drive = hardwareMap.dcMotor.get ("l_drv");
           //v_motor_left_drive.setDirection (DcMotor.Direction.REVERSE);
           box = hwMap.servo.get("box");
           if (box != null) {
               box.setPosition(SERVO_BOX_MIN);
           }
       ...
       if (left_front_drv_Motor != null) {
           ...
           left_front_drv_Motor.setDirection(DcMotor.Direction.REVERSE); // FORWARD was moving it backwards
 ...
 /*double a_stack2_power ()
 {
   ...
   double a_shaft_power()
   {
       double l_return = 0.0;
       if(shaft != null){
           l_return = shaft.getPower();
       }
       return l_return;
   }
 /*double a_intake2_power ()
 {
   ...
   double a_box_position ()
   {
       double l_return = 0.0;

       if (box != null)
       {
           l_return = box.getPosition ();
       }
    ...
    * Change the marker servo position.
    */
   void set_box_position (double p_position) {
       //
       // Ensure the specific value is legal.
       //
       double l_position = Range.clip
               (p_position , SERVO_BOX_MIN
                       , SERVO_BOX_MAX); // Servo position is restricted to protect from mechanical damage
   ...
   double a_hand1_position(){
       double l_return = 0.0;

       if(hand1 != null)
       {
           l_return = hand1.getPosition();
       }
       return l_return;
   }

   void set_hand1_position(double p_position)
   {
       double l_position = Range.clip(p_position, SERVO_HAND1_MIN,
               SERVO_HAND1_MAX);

       if(hand1 != null)
       {
           hand1.setPosition(l_position);
       }
   }

   double a_hand2_position(){
       double l_return = 0.0;

       if(hand2 != null)
       {
           l_return = hand2.getPosition();
       }
       return l_return;
   }

   void set_hand2_position(double p_position)
   {
       double l_position = Range.clip(p_position, SERVO_HAND2_MIN,
               SERVO_HAND2_MAX);

       if(hand2 != null)
       {
           hand2.setPosition(l_position);
       }
   }
